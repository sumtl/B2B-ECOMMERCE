            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow p-6 sticky top-4">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white px-4 py-3 rounded hover:bg-blue-700 font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition"
                >
                  {submitting ? "Placing Order..." : "Place Order"}
                </button>

                <Link href="/cart">
                  <button className="w-full mt-3 bg-gray-200 text-gray-900 px-4 py-2 rounded hover:bg-gray-300 transition">
                    Back to Cart
                  </button>
                </Link>
